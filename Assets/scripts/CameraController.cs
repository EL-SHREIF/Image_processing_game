...
public class CameraController : MonoBehaviour
{
    ...
    */
    ...
    private void Start()
    {
        ...
        Cv2.Line(level3part3Screen,new Point(backCam.width/2-100,backCam.height/2-100) ,new Point(backCam.width/2-100,backCam.height/2+100) , new Scalar(255, 0, 0), 10, LineTypes.Filled);
        Cv2.Line(level3part3Screen, new Point(backCam.width/2-100, backCam.height/2+100), new Point(backCam.width/2+100, backCam.height/2+100), new Scalar(255, 0, 0), 10, LineTypes.Filled);
        Cv2.Line(level3part3Screen, new Point(backCam.width/2+100, backCam.height/2+100), new Point(backCam.width/2+100, backCam.height/2-100), new Scalar(255, 0, 0), 10, LineTypes.Filled);
        Cv2.Line(level3part3Screen, new Point(backCam.width/2+100, backCam.height/2-100), new Point(backCam.width/2-100,backCam.height/2-100), new Scalar(255, 0, 0), 10, LineTypes.Filled);
